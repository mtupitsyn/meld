...
/opt/homebrew/bin/pip3 install six pygments packaging --target $PY_SITE_PACKAGES
# Need setuptools < 65.0.0 (e.g. <=64.0.3), virtualenv <= 20.16.3
/opt/homebrew/bin/pip3 install setuptools==64.0.3 virtualenv==20.16.3 --upgrade --target $HOME/.new_local/lib/python3.11/site-packages
